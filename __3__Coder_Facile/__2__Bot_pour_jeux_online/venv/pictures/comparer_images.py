...
def compare_picture_all_in_one():
    ...
    for i in range(1,7,1):
        ...
        screen_grab(coord_table) # Prend le screen de l'endroit et le stocke
...
def ini_images_source():
    ...
    onigiri = cv2.imread("\Images_sources\onigiri.png")
    caliroll = cv2.imread("\Images_sources\caliroll.png")
    gunkan = cv2.imread("\Images_sources\gunkan.png")
