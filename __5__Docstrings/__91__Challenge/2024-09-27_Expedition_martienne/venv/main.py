...
# Date de dernière modification: 2024-10-23
# ------------------------------------------
# version: 2.0
# - Suppression de l'arrondit à 10^3
...
def convert_list_dico(distances_liaisons):
    """
...
def recap_point(previous_node, depart, arrivee):
    ...
    :return:
    - list_nodes (str): Liste des noeuds du point de départ à l'arrivée
    """
    list_nodes = [arrivee]
    node = arrivee
