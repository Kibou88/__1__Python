...
# Date de dernière modification: 2024-06-20
# ------------------------------------------------------------------------------------------------
# version: 3.0
# - Importation du module complet tkintermapview + modif associé (V2)
# - Ajout et modification des coordonées GPS dans la partie "Constantes classe" (V2)
# - Ajout d'une constante "SPACING" permettant de faire les espaces entre chaque bouton + modif associé (V2)
# - Modification du zoom initial afin de voir tous les markers (V2)
# - Méthode "set_marker": ajout du ternaire dans "icon=" pour simplifier le code (V2)
# - Correction de la partie "Style" pour créer un style (V3)
#-------------------------------------------------------------------------------------------------
